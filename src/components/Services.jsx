    ...
    <Section id='how-to-use'>
      <div className='container'>
        ...
        <div className='relative'>
          <div className='relative flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]'>
            ...
            <div className='relative z-1 max-w-[17rem] ml-auto'>
              ...
              <ul className='body-2'>
                {brainwaveServices.map((item, index) => (
                  ...
                  >
                    <img width={24} height={24} src={check} alt='Check' loading='lazy'/>
                ...
                <ul className='flex items-center justify-between'>
                  {brainwaveServicesIcons.map((item, index) => (
                    ...
                    >
                      ...
                      >
                        <img src={item} width={24} height={24} alt={item} loading='lazy'/>
                      </div>
                    </li>
                  ))}
                </ul>
